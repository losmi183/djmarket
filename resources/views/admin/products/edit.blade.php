    ...
    <div class="col-md-8">
        <div class="card">
            ...
            <div class="card-body">
                ...
                <form action="{{route('products.update', $product->id)}}" class="add-category-form" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-md-6">
                            <input type="text" class="form-control @error('details') is-invalid @enderror" name="details" value="{{old('details') ?? $product->details}}">
                    ...
                    <div class="form-group row">
                        <label class="col-md-4 col-form-label text-md-right">Price(In Euro)</label>
                        <div class="col-md-6">
                            ...
                            <div class="input-group mb-3">
                                ...
                                <input type="number" class="form-control @error('price') is-invalid @enderror" name="price" value="{{old('price') ?? presentInEuros($product->price) }}">                       
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-md-6">
                            <input type="text" class="form-control @error('description') is-invalid @enderror" name="description" value="{{old('slug') ?? $product->description}}">
                        ...
                        <div class="col-md-6">
                            @foreach ($categories as $category)
                                <input type="checkbox" name="category[]" value="{{$category->id}}" {{ 
                                    in_array($category->id, $all_cats) ? 'checked' : ''
                                }}>
